...
\consultant{prof. Ing. Ján Kollár, CSc.} %konzultant
\college{Techincal University of Košice}{Technická univerzita v Košiciach} %univerzita
...
Časť "Pravdepodobnostná analýza kvantových obvodov" poukazuje na problémy, ktoré
...
\include{chapters/matZaklady}
\include{chapters/teorZaklady}
\include{chapters/kvantSystem}
\include{chapters/pravAnal}
\include{chapters/meranie}
\include{chapters/pravModel}
\include{chapters/kvanTel}
\include{chapters/vyhodnotenie}

%\include{chapters/vyprac}
%\include{chapters/bez}
...
\include{chapters/pprirucka}
\include{chapters/sprirucka}
